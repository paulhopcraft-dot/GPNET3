...
📊 WORK BREAKDOWN: [X total steps]
🧠 MODEL ALLOCATION: Primary=[MODEL] | OPUS:X SONNET:X HAIKU:X
⚡ APPROACH: [Complexity-based approach]
🎯 KEY COMMANDS: [Suggested slash commands]
⏱️ ESTIMATED SCOPE: [Complexity] - expect [X sessions]
🔍 CRITICAL PATHS: [Complex/important steps]
