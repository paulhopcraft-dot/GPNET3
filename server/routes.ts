...
import recoveryEstimatorRoutes from "./routes/recoveryEstimator";
...
export async function registerRoutes(app: Express): Promise<void> {
  ...
  // Case management routes (JWT-protected) - includes claims intake
  app.use("/api/cases", caseRoutes);

  // RTW Planner routes (JWT-protected) - PRD-3.2.3, PRD-8
  ...
  // Recovery Estimator routes (PRD-25, Spec-14)
  app.use("/api/recovery", recoveryEstimatorRoutes);
